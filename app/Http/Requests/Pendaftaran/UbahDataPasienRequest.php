...
class UbahDataPasienRequest extends FormRequest
{
    ...
    {
        $noRkmMedis = $this->route('noRkmMedis');

        return [
            'no_rkm_medis' => ['required', 'string', 'min:5', 'max:15', Rule::unique('pasien', 'no_rkm_medis')->ignore($noRkmMedis, 'no_rkm_medis')],
