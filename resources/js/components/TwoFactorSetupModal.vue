...
import { confirm } from '@/lib/twoFactorRoutes';
...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    ...
    return {
        ...
        description:
            'Untuk menyelesaikan aktivasi autentikasi dua faktor, pindai kode QR atau masukkan kunci pengaturan di aplikasi autentikator Anda',
        buttonText: 'Lanjutkan',
    };
});
