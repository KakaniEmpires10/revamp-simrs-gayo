...
import { regenerateRecoveryCodes } from '@/lib/twoFactorRoutes';
    ...
    <Card class="w-full">
        <CardHeader>
            ...
            <CardDescription>
                ...
                hilang. Simpan kode ini di pengelola kata sandi yang aman.
            </CardDescription>
        </CardHeader>
        <CardContent>
            <div
            ...
            >
                ...
                <div v-else class="mt-3 space-y-3">
                    ...
                    <p class="text-xs text-muted-foreground select-none">
                        ...
                        untuk mengakses akun dan akan dihapus setelah digunakan.
                        Jika membutuhkan kode baru, pilih
