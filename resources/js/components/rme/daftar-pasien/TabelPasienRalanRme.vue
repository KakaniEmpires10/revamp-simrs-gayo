...
import { Activity, AlertTriangle, ArrowDownNarrowWide, ArrowRightLeft, ArrowUpNarrowWide, Bed, CalendarClock, ChevronDown, ChevronRight, CreditCard, FileCheck2, FileText, FlaskConical, Hospital, IdCard, Pill, ScrollText, Stethoscope, UserRound, Waves } from '@lucide/vue';
    ...
    <section class="flex min-w-0 flex-col gap-3">
        ...
        <div class="w-full max-w-full min-w-0 overflow-x-auto">
            <InfiniteScroll
                ...
                items-element="#rme-ralan-table-body"
                only-next
                manual
            >
                <Table>
                    ...
                    <TableBody id="rme-ralan-table-body">
                                    ...
                                    <TableCell>
                                        <div class="grid min-w-60 gap-1.5">
                                            ...
                                            <div class="flex items-center gap-1.5 text-xs text-muted-foreground">
                                                ...
                                                <span>Jam SEP</span>
                                                <span class="font-mono text-foreground">{{ patient.jam_sep || '-' }}</span>
                                            </div>
                                            <TooltipProvider v-if="patient.nmdiagnosaawal">
                                                <Tooltip>
                                                    <TooltipTrigger as-child>
                                                        <Badge variant="soft-info" size="sm" class="max-w-60 justify-start">
                                                            <span class="truncate">{{ patient.nmdiagnosaawal }}</span>
                                                        </Badge>
                                                    </TooltipTrigger>
                                            ...
                                            <Badge v-else variant="muted" size="sm" class="justify-start">
                                                Diagnosa SEP belum tersedia
                                            </Badge>
                                        </div>
                                    </TableCell>
                                    <TableCell>
